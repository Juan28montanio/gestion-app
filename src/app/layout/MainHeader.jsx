...
export default function MainHeader({
  ...
  return (
    <header data-testid="app-header" className="relative z-20 border-b border-slate-200 bg-[#f4f6f8] px-4 py-4 md:px-6 xl:sticky xl:top-0 xl:z-50 xl:bg-[#f4f6f8]/95 xl:backdrop-blur">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0" data-testid="business-context">
            <p data-testid="business-name" className="text-xs font-semibold uppercase tracking-[0.22em] text-slate-400">
              {business?.name || "SmartProfit"}
            </p>
            <h1 data-testid="module-name" className="mt-1 text-[2rem] font-bold tracking-[-0.03em] text-slate-950 sm:text-2xl">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <time data-testid="current-date" className="inline-flex items-center rounded-full border border-slate-200 bg-white px-3 py-2 text-xs font-medium text-slate-600">
            {currentDateLabel}
          </time>
          <button
            type="button"
