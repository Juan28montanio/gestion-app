import{_ as ge,r as z,S as me,a as Re,b as be,g as we}from"./firebase-core-h1zRlpyh.js";import{C as Te,F as ye,j as v,e as ke,f as Z,p as Ee,u as Ae,h as Ue}from"./firebase-shared-DXlCRIsH.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pe="storage";function Mt(e,t,n){return e=v(e),Ot(e,t,n)}function Ht(e){return e=v(e),It(e)}function $t(e,t){return e=v(e),Dt(e,t)}function jt(e=we(),t){e=v(e);const s=be(e,pe).getImmediate({identifier:t}),r=ke("storage");return r&&vt(s,...r),s}function vt(e,t,n,s={}){xt(e,t,n,s)}function St(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new q(n,s,r,t,me)}function Lt(){ge(new Te(pe,St,"PUBLIC").setMultipleInstances(!0)),z(G,Y,""),z(G,Y,"esm2017")}Lt();export{Ht as a,jt as g,$t as r,Mt as u};
