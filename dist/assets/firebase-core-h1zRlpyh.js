import{L as B,C as l,E as O,g as S,d as w,a as P,b as y,i as N,v as F,F as A}from"./firebase-shared-DXlCRIsH.js";import{o as R}from"./vendor-C0DydOkg.js";/**
 * @license
 ...
 */class M{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(T(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function T(a){const e=a.getComponent();return(e==null?void 0:e.type)==="VERSION"}const m="@firebase/app",D="0.13.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const o=new B("@firebase/app"),k="@firebase/app-compat",U="@firebase/analytics-compat",j="@firebase/analytics",L="@firebase/app-check-compat",V="@firebase/app-check",G="@firebase/auth",z="@firebase/auth-compat",J="@firebase/database",Y="@firebase/data-connect",q="@firebase/database-compat",X="@firebase/functions",K="@firebase/functions-compat",W="@firebase/installations",Q="@firebase/installations-compat",Z="@firebase/messaging",ee="@firebase/messaging-compat",te="@firebase/performance",ae="@firebase/performance-compat",re="@firebase/remote-config",ne="@firebase/remote-config-compat",se="@firebase/storage",ie="@firebase/storage-compat",oe="@firebase/firestore",ce="@firebase/ai",pe="@firebase/firestore-compat",he="firebase",de="11.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pe=de;function ge(a,e={}){let t=a;typeof e!="object"&&(e={name:e});const r=Object.assign({name:g,automaticDataCollectionEnabled:!0},e),n=r.name;if(typeof n!="string"||!n)throw c.create("bad-app-name",{appName:String(n)});if(t||(t=S()),!t)throw c.create("no-options");const s=f.get(n);if(s){if(w(t,s.options)&&w(r,s.config))return s;throw c.create("duplicate-app",{appName:n})}const i=new P(n);for(const v of u.values())i.addComponent(v);const p=new me(t,r,i);return f.set(n,p),p}function Ne(a=g){const e=f.get(a);if(!e&&a===g&&S())return ge();if(!e)throw c.create("no-app",{appName:a});return e}function d(a,e,t){var r;let n=(r=le[a])!==null&&r!==void 0?r:a;t&&(n+=`-${t}`);const s=n.match(/\s|\//),i=e.match(/\s|\//);if(s||i){const p=[`Unable to register library "${n}" with version "${e}":`];s&&p.push(`library name "${n}" contains illegal characters (whitespace or "/")`),s&&i&&p.push("and"),i&&p.push(`version name "${e}" contains illegal characters (whitespace or "/")`),o.warn(p.join(" "));return}_(new l(`${n}-version`,()=>({library:n,version:e}),"VERSION"))}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Se(a){_(new l("platform-logger",e=>new M(e),"PRIVATE")),_(new l("heartbeat",e=>new Ee(e),"PRIVATE")),d(m,D,a),d(m,D,"esm2017"),d("fire-js","")}Se("");var ye="firebase",Ae="11.10.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */d(ye,Ae,"app");export{Pe as S,_,Oe as a,Be as b,Ne as g,ge as i,d as r};
